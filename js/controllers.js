...
angular.module('app.controllers', ['pascalprecht.translate', 'ngCookies',])
    .controller('AppCtrl', ['$scope', '$translate', '$localStorage', '$window', 'httpApiService',
        function($scope, $translate, $localStorage, $window, httpApiService) {
            ...
            // 保存设置到本地存储
            //angular.isDefined 判断给定的对象是否被定义过
            ...
            $scope.langs = {cn:'中文', en:'英文', de_DE:'德文', it_IT:'意大利'};
    ...
    // signin controller
    .controller('SigninFormController', ['$scope', '$http', '$state', 'httpApiService',
        function($scope, $http, $state, httpApiService) {
        $scope.user = {
            email: ""
        };
